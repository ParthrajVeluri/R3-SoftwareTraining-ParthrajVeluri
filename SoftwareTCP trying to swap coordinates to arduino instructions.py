...
for i in range(0,len(solution)-1):
    x = solution[i+1]
    coordinateCommand.append(np.subtract(x,solution[i]))
    print(coordinateCommand[i])


motorCommand = []
print(len(coordinateCommand))
for i in range(0,len(coordinateCommand)):
    if coordinateCommand[coordinateCommand[i]>0] == [1,0]
        print("Go Down")
